    ...
    protected void onStart()
    {
        ...
        deviceListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                deviceListView.getItemAtPosition(i);
                ...
                try {
                    ...
                    body.put("op", "change");
                    body.put("ref", "Zw9vzpilQ_L1");
                    property.put("switch", new JSONObject().put("value", true).put("status", "pending"));
                    body.put("properties", property);
                    bodyFrame.put(body);
                    sendAction.put("body", bodyFrame);
                    sendAction.put("callback", "toggleSwitch");
